...
# Mock CLI that outputs non-JSON lines mixed with valid JSON.
set -e
...
# Output a non-JSON line before the response (e.g., CLI startup warning)
echo "WARNING: some CLI startup message"
...
# Output another non-JSON line during streaming
